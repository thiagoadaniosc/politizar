  ...
  <div id="home-main" class="col-lg-12">
    ...
    <div id="home-deputados" class="animated bounceInLeft ">
      <main class="container">
        ...
        <p class="text-white text-justify col-lg-9 float-right">O Poder Legislativo, segundo o art. 44 da Constituição Federal de 1988, é exercido pelo Congresso nacional, que se compõe da Câmara dos Deputados e do Senado Federal. Portanto, se organiza como um poder bicameral.
          A Câmara é composta por representantes do povo, eleitos pelo sistema proporcional em cada estado, em cada território e no Distrito Federal. São 513 deputados federais, com mandato de quatro anos. O número de deputados é proporcional à população do estado ou do Distrito Federal, com o limite mínimo de oito e máximo de setenta deputados para cada um deles.</p>
      ...
      <div id="home-senadores" class="bg-dark animated bounceInLeft">
        <main class="container">
          ...
          <div class="border-title"></div>
          <p class="text-justify text-white col-lg-10 float-right">O Senado Federal é a câmara alta do Congresso Nacional do Brasil e,
            ao lado da Câmara dos Deputados, faz parte do Poder Legislativo da União.
            <br/>O Senado Federal tem sido, ao longo de seus quase 200 anos de existência, um dos pilares da estabilidade institucional do Brasil. Para além de sua inquestionável importância política, ele possui funções legislativas de caráter mais geral que são compartilhadas com a Câmara dos Deputados, outras, são de sua exclusiva competência.</p>
            <div class="col-lg-2 pl-0">
              <img src="imgs/senado.png" alt="www.flaticon.com" class="m-auto p-auto rounded rounded" height="150px" alt="">
            </div>
            <div class="col-lg-12 mt-3" style="height:0px;">
                <button type="button" onclick="return window.location = '/senadores'" class="btn btn-primary float-right btn-senadores" name="button">Conhecer Senadores</button>
            </div>
          </main>
        </div>
        ...
        <div id="home-vereadores" class="bg-dark animated bounceInLeft">
          <main class="container">
            ...
            <p class="text-justify text-white float-right col-lg-10">
              O Poder Legislativo do Município é exercido pela Câmara Municipal. É composta por 19 vereadores, representantes das comunidades, eleitos pelo voto direto e secreto, no sistema proporcional, e está na 19º Legislatura (2017 – 2020).
              Os vereadores têm a função de fiscalizar o Poder Executivo e produzir leis, preservando o bem da comunidade. Em sua área de atuação, a Câmara Municipal propõe, delibera e vota Projetos de Leis, Projetos de Decretos Legislativos, Projetos de Resoluções e outras matérias.
            </p>
            <div class="col-lg-2 pl-0">
              <img src="imgs/vereadores_sj.png" alt="www.flaticon.com" class="m-auto p-auto rounded rounded" height="150px" alt="">
            </div>
            <button type="button" class="btn btn-primary float-right btn-vereadores" name="button">Conhecer Vereadores</button>
          </main>
        </div>
        ...
        <div id="home-executivo" class="animated bounceInLeft ">
          <main class="container">
            ...
            O Poder Executivo é exercido pelo Presidente da República, auxiliado pelos Ministros de Estado.
              ...
              <img src="imgs/executivo.png" class="col-lg-3 m-auto p-auto" height="120px" alt="">
              <div class="col-lg-12 mt-3" style="height:0px;">
                <button type="button" onclick="return window.location = '/executivo'" class="btn btn-primary float-right btn-executivo" name="button">Conhecer o Executivo</button>
              </div>
            </main>
          </div>
          ...
          <div id="home-stf" class="animated bounceInLeft ">
            <main class="container">
              ...
              <p class="text-white text-justify col-lg-9 float-right">
                O poder judiciário é aquele que é responsável por interpretar e julgar as causas de acordo com a constituição do estado. É formado por magistrados tais como, juízes, desembargadores, promotores de justiça e ministros. É um poder tido como independente aos outros, visto que têm por objetivo julgar com imparcialidade, inclusive causas inerentes ao Executivo e ao Legislativo além das próprias pautas e as de interesses públicos e individuais, próprios do Judiciário .
              </p>
                <img src="imgs/stf.png" class="col-lg-3 m-auto p-auto" alt="https://pt.vecteezy.com/" height="150px" width="200px" alt="">
                <div class="col-lg-12 mt-3" style="height:0px;">
                  <button type="button" onclick="return window.location = '/stf'" class="btn btn-primary float-right btn-stf" name="button">Conhecer o Judiciário</button>
                </div>
              </main>
            </div>
